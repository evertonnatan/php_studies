...
<body class="w3-light-grey">
    ...
    <div class="w3-padding-large" id="main">
        ...
        <header class="w3-container w3-padding-32 w3-center " id="home">
            <h1>
                <img src="../img/curriculum.png" alt="Logo" class="w3-image" width="10%">
                </br>
            </h1>
    ...
    <div class="w3-padding-128 w3-content w3-text-grey" id="eProfissional">
        ...
        <form action="/Controller/Navegacao.php" method="post" class=" w3-row  w3-light-grey w3-text-blue w3-margin" style="width: 70%;">
            <div class="w3-row w3-center">
                <div class="w3-col" style="width:50%;">Data Inicial
                </div>
                <div class="w3-reset">Data Final
                </div>
            </div>
            <div class="w3-row w3-section">
                <div class="w3-row w3-section w3-col" style="width:45%;">
        ...
        <form action="../Controller/Navegacao.php" method="post" class=" w3-row  w3-light-grey w3-text-blue w3-margin" style="width: 70%;">
            ...
            <div class="w3-row w3-section">
                ...
                <div>
                    ...
                    <div class="w3-row w3-section">
                        <div class="w3-center" style="">
                            <button name="btnAddOutrasFormacoes" class="w3-button w3-block  w3-blue w3-cell w3-round-large" style="width: 20%;">
                                <i class="w3-xxlarge fa fa-user-plus"></i>
                    ...
                    <div class="w3-container">
                        <table class="w3-table-all w3-centered">
                            ...
                            <tbody>
                                ...
                                $results = $ofController->gerarLista(unserialize($_SESSION['Usuario'])->getID());
                                if ($results != null) {
                                    while ($row = $results->fetch_object()) {
                                        echo '<tr>';
                                        echo '<td style="width: 10%;">' . $row->inicio . '</td>';
