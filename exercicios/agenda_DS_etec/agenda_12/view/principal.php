...
<body class="w3-light-grey">
    ...
    <div class="w3-padding-large" id="main">
        <header class="w3-container w3-padding-32 w3-center" id="home">
            <h1>
                <img src="../img/curriculum.png" alt="Logo" class="w3-image" width="50%">
            </h1>
            <br>
    ...
    <div class="w3-padding-128 w3-content w3-text-grey" id="dPessoais">
        ...
        <form action="" method="post" class="w3-row w3-light-grey w3-text-blue w3-margin" style="width:70%;">
            ...
            <div class="w3-row w3-section">
                ...
                <div class="w3-rest">
                    <input class="w3-input w3-border w3-round-large" name="txtNome" type="text" placeholder="Nome Completo" value="" id="dPessoais">
                </div>
            </div>
            <div class="w3-row w3-section">
                <div class="w3-col" style="width: 11%;">
                    <i class="w3-xxlarge fa fa-id-card w3-text-blue"></i>
                </div>
                <div class="w3-rest">
            ...
            <div class="w3-row w3-section">
                <div class="w3-col" style="width: 11%;">
                    <i class="w3-xxlarge fa fa-calendar w3-text-blue"></i>
                </div>
                <div class="w3-rest">
            ...
            <div class="w3-row w3-section">
                <div class="w3-col" style="width: 11%;">
                    <i class="w3-xxlarge fa fa-envelope w3-text-blue"></i>
                </div>
                <div class="w3-rest">
                    <input class="w3-input w3-border w3-round-large" name="txtEmail" type="text" placeholder="E-mail" value="">
                </div>
            </div>
            <div class="w3-row w3-section">
                <div class="w3-rest">
                    <button class="w3-button w3-blue w3-round-large w3-block" name="btnAtualizar">Atualizar</button>
                </div>
            </div>
        </form>
    </div>
    ...
    <div class="w3-padding-128 w3-content w3-text-grey" id="outrasFormacoes">
        ...
        <form action="" method="post" class="w3-row w3-light-grey w3-text-blue w3-margin" style="width:70%;">
            <div class="w3-row w3-center">
                <div class="w3-col" style="width:50%;">Início</div>
                <div class="w3-rest">Fim</div>
            </div>
            <div class="w3-row w3-section">
                <div class="w3-row w3-section w3-col" style="width:45%;">
                    <div class="w3-col" style="width:15%;">
            ...
            <div class="w3-row w3-section">
                ...
                <div class="w3-rest">
                    <input class="w3-input w3-border w3-round-large" name="txtDescOF" type="text" placeholder="Descrição: Ex.: Formações adicionais">
                </div>
            </div>
            <div class="w3-row w3-section">
                <div class="w3-center" style="">
