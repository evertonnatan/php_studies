...
<a href="index.php" class="w3-display-topleft">
 <i class="fa fa-arrow-circle-left w3-large w3-deep-purple w3-button w3-
xxlarge"></i> 
</a> 
<div class="w3-padding w3-content w3-text-grey w3-third w3-margin w3-displaymiddle">
<h1 class="w3-center w3-deep-purple w3-round-large w3-margin">Atualizar -
ID: <?php echo " ".$_GET['id']?> </h1>
...
border" value="<?php echo $_GET['nome']?>">
 ...
 <input name="txtPreco" class="w3-input w3-light-grey w3-
border" value="<?php echo $_GET['preco']?>">
 <br>
 <label class="w3-text-deep-purple " style="fontweight: bold;">Quantidade</label>
 <input name="txtQtd" class="w3-input w3-light-grey w3-
border" value="<?php echo $_GET['quantidade']?>">
 <br>
 <button name="btnAtualizar" class="w3-button w3-deep-purple w3-
cell w3-round-large w3-right">
