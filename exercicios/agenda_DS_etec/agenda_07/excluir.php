...
<body class="w3-black">
<a href="index.php" class="w3-display-topmiddle w3-red w3-center w3-
...
<div class="w3-padding w3-content w3-text-grey w3-third w3-margin w3-displaymiddle">
 <h1 class="w3-center w3-indigo w3-round-large w3-margin">EXLUIR -
...
border" type="hidden" value="<?php echo $_GET['id']?>">
 ...
 <input name="txtNome" class="w3-input w3-grey w3-
border" disabled value="<?php echo $_GET['nome']?>">
 <br>
 <label class="w3-text-indigo" style="font-weight: bold;">Preco</label>
 <input name="txtPreco" class="w3-input w3-gray w3-
border" disabled value="<?php echo $_GET['preco']?>">
 <br>
 <label class="w3-text-indigo" style="fontweight: bold;">Quantidade</label>
 <input name="txtQtd" class="w3-input w3-gray w3-
border"disabled value="<?php echo $_GET['quantidade']?>">
 <br>
